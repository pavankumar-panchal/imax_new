...
$grid .= '<tr bgcolor="#D8DFE7" style="font-weight:bold"><td nowrap = "nowrap" class="td-border-grid">Sl No</td><td nowrap = "nowrap" class="td-border-grid">Dealer Company Name</td><td nowrap = "nowrap" class="td-border-grid">Dealer Name</td><td nowrap = "nowrap" class="td-border-grid">Contact Number</td><td nowrap = "nowrap" class="td-border-grid">Email ID</td><td nowrap = "nowrap" class="td-border-grid">Category</td><td nowrap = "nowrap" class="td-border-grid">Place</td><td nowrap = "nowrap" class="td-border-grid">District</td><td nowrap = "nowrap" class="td-border-grid">State</td><td nowrap = "nowrap" class="td-border-grid">Skype ID</td></tr>';
...
$grid .= '</table>';
		...
		$filebasename = "S_DM".$localdate."-".$localtime.".xls";
