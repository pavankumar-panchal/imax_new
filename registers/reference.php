...
<script language="javascript" src="../functions/referenceregister.js?dummy = <? echo (rand());?>" type="text/javascript"></script>
              ...
              <tr>
                <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <span id="getcustomerlink" style="visibility:visible;"> <a href="javascript:void(0);" onClick="getcustomer(); getcustomerfunc();registernameload('reference')" style="cursor:pointer"> <img src="../images/userid-bg.gif" width="14" height="16" border="0" align="absmiddle" /></a></span>
                        <input type="hidden" name="lastslno" id="lastslno" value="" />
                          ...
                          <input type="hidden" name="customerid" id="customerid" value="<? echo(datetimelocal('d-m-Y')); ?>"/></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top"><input name="time" type="text" class="swifttext" id="time" size="30" autocomplete="off" readonly="readonly" style="background:#FEFFE6;" value="<? echo($localtime); ?>" /></td>
                    </tr>
                    <tr bgcolor="#f7faff">
