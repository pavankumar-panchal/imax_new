              ...
              <tr>
                <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <span id="getcustomerlink" style="visibility:visible;"><a href="javascript:void(0);" onClick="getcustomer(); getcustomerfunc();registernameload('skype')" style="cursor:pointer"> <img src="../images/userid-bg.gif" width="14" height="16" border="0" align="absmiddle" /></a></span>
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top">
                        <input name="date" type="text" class="swifttext" id="date" size="30" autocomplete="off" readonly="readonly" style="background:#FEFFE6;" value="<?php echo(datetimelocal('d-m-Y')); ?>" />                        </td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Time:</td>
                      <td valign="top">
                        <input name="time" type="text" class="swifttext" id="time" size="30" autocomplete="off" readonly="readonly" style="background:#FEFFE6;" value="<?php echo(datetimelocal('H:i:s')); ?>" />                        </td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top"><input name="sender" type="text" class="swifttext" id="sender" size="30"  autocomplete="off" /></td>
                    </tr>
                </table></td>
                <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#EDF4FF">
                      ...
                      <td valign="top"><textarea name="conversation" cols="45" class="swifttextarea" id="conversation"></textarea></td>
                    </tr>
                    <tr bgcolor="#EDF4FF">
                      <td valign="top" bgcolor="#F7FAFF">Attachment:</td>
                      <td valign="top" bgcolor="#F7FAFF"><input name="attachment" type="text" class="swifttext" id="attachment" size="30"  autocomplete="off" readonly="readonly"  style="background:#FEFFE6;"/>
                        <img  id="myfileuploadimage" src="../images/fileattach.jpg" border="0" align="absmiddle" onclick="fileuploaddivid('downloadlinkfile','attachment','fileuploaddiv','255px','65%')"/> <span id="downloadlinkfile"></span></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top" bgcolor="#F7FAFF"><textarea name="remarks" cols="45" class="swifttextarea" id="remarks"></textarea></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                      <td valign="top" bgcolor="#EDF4FF">Entered By:</td>
                      <td valign="top" bgcolor="#EDF4FF"><input name="userid" type="text" class="swifttext" id="userid" size="30" readonly="readonly" value="<?php echo($loggedusername); ?>"  autocomplete = "off"  style="background:#FEFFE6;"/></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top" bgcolor="#F7FAFF">Skype ID:</td>
                      <td valign="top" bgcolor="#F7FAFF"><input name="skypeid" type="text" class="swifttext" id="skypeid" size="30" maxlength="40" readonly="readonly" style="background:#FEFFE6;" autocomplete="off"/></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
              ...
              <tr>
                <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top"><input name="todate" type="text" class="swifttext" id="DPC_todate" size="30" autocomplete="off"   style="background:#FEFFE6;" value="<?phpecho(datetimelocal('d-m-Y')); ?>" />                        </td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Anonymous:</td>
 ...
 SSM Users</label></td>
                ...
                <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="s_attachment" type="text" class="swifttext" id="s_attachment" size="30"  autocomplete="off"/></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="s_skypeid" type="text" class="swifttext" id="s_skypeid" size="30" maxlength="40" autocomplete="off"/></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
