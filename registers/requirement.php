...
<div id="contentdiv" style="display:block;">
  <table width="100%" border="0" cellspacing="0" cellpadding="4">
    <tr>
      <td class="content-header">Registers > Requirements</td>
    </tr>
    <tr>
      <td></td>
    </tr>
                    ...
                    <tr>
                      <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top"><select name="database2" id="database" class="swiftselect">
                              <option value="">Make A Selection</option>
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><textarea name="requirement" cols="45" class="swifttextarea" id="requirement"></textarea>
                      ...
                      <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr bgcolor="#f7faff">
                            <td valign="top" bgcolor="#EDF4FF">Solution Given:</td>
                            <td valign="top" bgcolor="#EDF4FF"><textarea name="solutiongiven" cols="45" class="swifttextarea" id="solutiongiven"></textarea></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top" bgcolor="#F7FAFF">Solution Entered Time:</td>
                            <td valign="top" bgcolor="#F7FAFF"><input name="solutionenteredtime" type="text" class="swifttext" id="solutionenteredtime" size="30" readonly="readonly" style="background:#FEFFE6;" value=""  autocomplete="off"/></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top" bgcolor="#EDF4FF">Remarks:</td>
                            <td valign="top" bgcolor="#EDF4FF"><textarea name="remarks" cols="45" class="swiftselect" id="remarks"></textarea></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                          ...
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top" bgcolor="#EDF4FF"><input name="requirementid" type="text" class="swifttext" id="requirementid" size="30" readonly="readonly" style="background:#FEFFE6;"  autocomplete="off"/></td>
                          </tr>
                           <tr bgcolor="#edf4ff">
...
&nbsp;&nbsp;&nbsp;
<input name="requirementreport" type="submit" class="swiftchoicebuttondisabled" id="requirementreport" value="Req. Report"  onclick="formsubmit('requirementreport')" disabled="disabled"/></td>
              </tr>
</table>
</td>
              </tr>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="2">
                    <tr>
                      <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr bgcolor="#f7faff">
                            <td valign="top" bgcolor="#EDF4FF">Requirement:</td>
                            <td valign="top" bgcolor="#EDF4FF"><input name="s_requirement" type="text" class="swifttext" id="s_requirement" value="" size="30" /></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                          ...
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top" bgcolor="#EDF4FF"><select name="s_status" id="s_status" class="swiftselect">
                      ...
                      <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top"><input name="s_requirementid" type="text" class="swifttext" id="s_requirementid" size="30" maxlength="40"  autocomplete="off"/></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
