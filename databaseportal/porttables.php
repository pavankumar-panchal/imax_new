...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="fromtable" type="text" class="swifttext" id="fromtable" size="30" />
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top"><input name="fromtablefields" type="text" class="swifttext" id="fromtablefields" size="60" /></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Destination Table Name:</td>
                      <td valign="top"><input name="totable" type="text" class="swifttext" id="totable" size="30" /></td>
                    </tr>
                    <tr bgcolor="#EDF4FF">
                      <td valign="top">Destination Table Fields:</td>
                      <td valign="top"><input name="totablefields" type="text" class="swifttext" id="totablefields" size="60" /></td>
                    </tr>
                </table></td>
                </tr>
              <tr>
  ...
  <tr>
                <td width="68%" height="35" align="left" valign="middle"><div id="form-error"><? if($message <> '') echo($message); ?></div></td>
