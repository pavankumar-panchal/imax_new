...
<body><form name="submitform" method="post">
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
    <td colspan="2"><strong><? echo($message); ?></strong></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Category:</td>
    <td><input name="newdealercategory" type="text" class="swifttext" id="newdealercategory" size="60" value="" /></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>Callertype:</td>
    <td><input name="newdealercallertype" type="text" class="swifttext" id="newdealercallertype" value="dealer" size="60" readonly="readonly" /></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
