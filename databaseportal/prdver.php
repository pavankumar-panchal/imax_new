              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="productcode" type="text" class="swifttext" id="productcode" size="30" /></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Old Version:</td>
                      <td valign="top"><input name="productversionold" type="text" class="swifttext" id="productversionold" size="30" />
