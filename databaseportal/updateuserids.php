              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="username" type="text" class="swifttext" id="username" size="30" />
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top"><input name="userid" type="text" class="swifttext" id="userid" size="30" /></td>
                    </tr>
                </table></td>
                </tr>
              <tr>
