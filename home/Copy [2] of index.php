...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
              ...
              <tr>
                <td align="right" valign="bottom" class="top-small-text">Logged In as: <? echo(ucwords(strtolower($loggedusername)).'   &nbsp;[ <u>'.ucwords(strtolower($usertype)).'</u> ]'); ?> | <span class="logout-text"><a href="./index.php?a_link=logout">Logout</a></span></td>
              </tr>
            </table></td>
        </tr>
        <tr height="4">
        ...
        <tr>
          <td colspan="2"><? include('../inc/navigation.php'); ?></td>
        </tr>
        <tr>
          <td colspan="2" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-top:#C6C3C6 solid 1px;border-bottom:#C6C3C6 solid 1px;">
              <tr>
                <td width="182" valign="top" style="border-right:#C6C3C6 solid 1px; padding:4px; background-color:#F0EADE;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td valign="top" class="lt-mid"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                          <? if($usertype == 'TEAMLEADER' || $usertype == 'ADMIN'  || $usertype == 'MANAGEMENT') { ?><tr>
                ...
                <td valign="top" class="content-box"><input name="navigationtabcount" id="navigationtabcount" type="hidden" value="<? echo($navigationtabcount); ?>" /> <? if(!$_GET['a_link'] || $_GET['a_link'] == 'home_dashboard') { ?> 
                            ...
                            <tr>
                              <td><div id="tabgroupgridc1" style="display:block;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                  ...
                                  <tr>
                                    <td><u>Today - <? echo(date("F j, Y", mktime (0,0,0,date(n)))); ?></u></td>
                                  </tr>
                                  <tr>
                                    <td>In Time: <? echo($tintimeresult); ?></td>
                                  </tr>
                                  <tr>
                                    <td><u>Last Working Day: <? echo(changedateformat($ydateresult)); ?></u></td>
                                  </tr>
                                  <tr>
                                    <td>In Time: <? echo($yintimeresult); ?> | Out Time: <? echo($youttimeresult); ?></td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                                  </tr>
  ...
  <tr>
    <td></td>
				...
				<? } else { $pagelink = getpagelink($_GET['a_link']); include($pagelink); }?>
                </td>
              </tr>
            </table></td>
        </tr>
