...
if($_POST['send'])
{
	...
	if($message == "")
	{
		$query = "SELECT * FROM ssm_users WHERE officialemail = '".$emailid."'";
...
<title>SSSM - Forget User id</title>
          ...
          <table width="25%" border="0" align="center" cellpadding="3" cellspacing="0">
            ...
            <tr>
              <td colspan="2" style="padding:0"><table width="100%" border="0" cellspacing="0" cellpadding="4" style="border:1px solid #a9a9a9;" bgcolor="#F8F8F8">
                  ...
                  <tr>
                    <td colspan="2" align="center" bgcolor="#F8F8F8"><a href="#">Go Back to Login Page</a><a href="#"></a></td>
                  </tr>
              </table></td>
            </tr>
            <tr  bgcolor="#a9a9a9">
