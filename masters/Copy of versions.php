...
<script language="javascript" src="../functions/versionmaster.js" type="text/javascript"></script>

<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
    <td class="content-header">Masters > Versions</td>
  </tr>
  <tr>
    <td></td>
  </tr>
              ...
              <tr>
                <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top"><input name="productversion" type="text" class="swifttext" id="productversion" size="30" />                      </td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Release Date:</td>
                      <td valign="top">
                        <input name="releasedate" type="text" class="swifttext" id="releasedate" size="30" onclick="displayDatePicker('releasedate');" readonly="readonly" style="background:#FEFFE6;" />
                      </td>
                    </tr>
                </table></td>
                <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><div id="productshortformatdisplay"><input name="shortformat" type="text" class="swifttext" id="shortformat" size="30" readonly autocomplete = "off" value="Select A Product" /></div></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                      <td valign="top">Is product in use:</td>
                      <td valign="top"><div id="productinusedisplay">
                        <input name="productinuse" type="text" class="swifttext" id="productinuse" size="30" readonly autocomplete = "off" value="Select A Product" />
                      </div></td>
                    </tr>
                </table></td>
              </tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="2">
              ...
              <tr>
                <td colspan="2" valign="middle" style="padding-right:15px; border-top:1px solid #d1dceb;" height="35">In:
                  ...
                  Product Name</label>
                  <label>
                  <input type="radio" name="databasefield" id="databasefield0" value="releasedate" /> 
                  Release Date
</label>
                  <label>
