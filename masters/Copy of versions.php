                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="3">
                        <tr bgcolor="#f7faff">
                          ...
                          <td valign="top"><select name="productname" class="swiftselect" id="productname"
                              onChange="prdshortformatinuseFunction();">
                        ...
                        <tr bgcolor="#f7faff">
                          ...
                          <td valign="top">
                            <input name="releasedate" type="text" class="swifttext" id="releasedate" size="30"
                              onclick="displayDatePicker('releasedate');" readonly="readonly"
                    ...
                    <td width="50%" valign="top">
                      <table width="100%" border="0" cellspacing="0" cellpadding="3">
                        <tr bgcolor="#f7faff">
                          ...
                          <td valign="top">
                            <div id="productshortformatdisplay"><input name="shortformat" type="text" class="swifttext"
                                id="shortformat" size="30" readonly autocomplete="off" value="Select A Product" /></div>
                          </td>
                        </tr>
                        <tr bgcolor="#edf4ff">
                          <td valign="top">Is product in use:</td>
                          <td valign="top">
                            <div id="productinusedisplay">
                              <input name="productinuse" type="text" class="swifttext" id="productinuse" size="30"
                                readonly autocomplete="off" value="Select A Product" />
                            </div>
                          </td>
                        </tr>
                      </table>
