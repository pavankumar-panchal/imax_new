              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top"><input name="remarks" type="text" class="swifttext" id="remarks" size="50" /></td>
                    </tr>
                </table></td>
                </tr>
              <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="2">
              ...
              <tr>
                <td colspan="2" valign="middle" style="padding-right:15px; border-top:1px solid #d1dceb;" height="35">In:
                  <label>
                  <input name="databasefield" type="radio" id="databasefield0" value="categoryheading" checked="checked" /> 
                  Category Heading
</label>
                  <label>
  ...
  <tr>
    <td style="padding:0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr style="border-left:none; border-right:none;">
        ...
        </table></td><td><span id="tabgroupgridwb1"></span><span id="tabgroupgridwb2"></span></td>
      </tr>
