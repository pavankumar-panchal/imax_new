...
<script language="javascript" src="../functions/osmaster.js?dummy = <? echo (rand());?>" type="text/javascript"></script>
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
    <td class="content-header">Masters > Out Station Employees</td>
  </tr>
  <tr>
    <td></td>
  </tr>
              ...
              <tr>
                <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="oscompanyname" type="text" class="swifttext" id="oscompanyname" size="30" />
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top"><input name="osname" type="text" class="swifttext" id="osname" size="30" /></td>
                    </tr>
                    <tr bgcolor="#f7faff">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="2">
              ...
              <tr>
                <td colspan="2" valign="middle" style="padding-right:15px; border-top:1px solid #d1dceb;" height="35">In:
                  ...
                  Sl No</label>
                  <label>
                  <input type="radio" name="databasefield" id="databasefield0" value="oscompanyname" />
OS Company</label>
                  <label>
