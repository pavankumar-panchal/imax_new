              ...
              <tr>
                <td valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top">
                        <input name="releasedate" type="text" class="swifttext" id="DPC_releasedate" size="30"  style="background:#FEFFE6;" />                      </td>
                    </tr>
                </table></td>
                </tr>
              <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="2">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top">
                      	<div id="textname" style="display:block">
                        	<input name="searchcriteria" type="text" class="swifttext" id="searchcriteria" size="40" />
                        </div>
              ...
              <tr>
                <td colspan="2" valign="middle" style="padding-right:15px; border-top:1px solid #d1dceb;" height="35">In:
                  <label>
                  <input type="radio" name="databasefield" id="databasefield0" value="productname" checked="checked" onclick="prdname('textname',databasefield0);"/>
                  Product Name</label>
                  <label>
                  <input type="radio" name="databasefield" id="databasefield2" value="releasedate" onclick="prdname('textname',databasefield2);"/> 
                  Release Date</label>
                  <label>
                   <input type="radio" name="databasefield" id="databasefield1" value="productgroup" onclick="prdgroup('groupname',databasefield1);" /> 
                  Product Group</label></td>
              </tr>
              <tr>
