                      ...
                      <td valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="3">
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><label><input type="radio" name="anonymous" id="databasefield11"
                                  value="yes" /> Yes</label>
                              <label><input type="radio" name="anonymous" id="databasefield12" value="no" /> No</label>
                              <label><input type="radio" name="anonymous" id="databasefield13" value=""
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" height="35">
                          <tr>
                            ...
                            <td width="32%" height="35" align="right" valign="middle"><input name="view" type="submit"
                                class="swiftchoicebutton" id="view" value="View" onClick="formsubmit('view');" />
                              &nbsp;&nbsp;&nbsp;
