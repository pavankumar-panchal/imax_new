...
<script language="javascript" src="../functions/call-statistics.js?dummy = <? echo (rand());?>" type="text/javascript"></script>
...
<input type="hidden" name="lastslno" id="lastslno" value="" />
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top"><input name="fromdate" type="text" class="swifttext" id="DPC_fromdate" size="30" autocomplete="off"  style="background:#FEFFE6;"  value="<? echo(datetimelocal('d-m-Y')); ?>"/></td>
                    </tr>
                    <tr bgcolor="#f7faff">
