            ...
            <td colspan="2" valign="top">
              <div id="maindiv">
                <div>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="right"><a href="#null" onclick="printContent('printonsitependingvisits')">
                          <font style="font-size:11px; font-family:Verdana, Arial, Helvetica, sans-serif;">Print this
                            page</font>
                        </a></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td>
                              <div id="printonsitependingvisits"></div>
                            </td>
                          </tr>
                        </table>
                      </td>
