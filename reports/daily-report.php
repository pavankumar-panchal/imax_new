...
<!--<script src="../js/jquery-1.4.2.min.js?dummy=<? echo (rand());?>" language="javascript"></script>
              ...
              <tr>
                <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    <tr bgcolor="#edf4ff">
                      ...
                      <input name="username" type="hidden" class="swifttext" id="username"  value="<? echo($user); ?>" /></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">To Date:</td>
                      <td valign="top"><input name="todate" type="text" class="swifttext" id="DPC_todate" size="30" autocomplete="off"    style="background:#FEFFE6;"  value="<? echo(datetimelocal('d-m-Y')); ?>" />
                      <input name="usertype" type="hidden" class="swifttext" id="usertype"  value="<? echo($usertype); ?>" /></td>
                    </tr>
