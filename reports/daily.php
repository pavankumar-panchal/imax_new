                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="3">
                          <tr bgcolor="#f7faff">
                            ...
                            <td valign="top"><label><input name='check[]' type='checkbox' value='Call' />
                                ...
                                Requirements</label><a href="javascript:void(0);"
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><input name="fromdate2" type="text" class="swifttext" id="fromdate2"
                                size="30" autocomplete="off" onclick="displayDatePicker('fromdate');"
                                onkeypress="datemakereadonly(event,this);" readonly="readonly"
                                style="background:#FEFFE6;" /></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                            <td valign="top">To Date:</td>
                            <td valign="top"><input name="todate2" type="text" class="swifttext" id="todate2" size="30"
                                autocomplete="off" onclick="displayDatePicker('todate');"
                                onkeypress="datemakereadonly(event,this);" readonly="readonly"
                                style="background:#FEFFE6;" /></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                    ...
                    <tr>
                      <td width="50%" valign="top" style="border-right:1px solid #d1dceb;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="3">
                          <tr bgcolor="#f7faff">
                            <td valign="top">From Date:</td>
                            <td valign="top"><input name="fromdate" type="text" class="swifttext" id="fromdate"
                                size="30" autocomplete="off" onClick="displayDatePicker('fromdate');"
                                onKeyPress="datemakereadonly(event,this);" readonly="readonly"
                                style="background:#FEFFE6;" /></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top">To Date:</td>
                            <td valign="top"><input name="todate" type="text" class="swifttext" id="todate" size="30"
                                autocomplete="off" onclick="displayDatePicker('todate');"
                                onKeyPress="datemakereadonly(event,this);" readonly="readonly"
                                style="background:#FEFFE6;" /></td>
                          </tr>
                          ...
                          <tr bgcolor="#f7faff">
                            <td valign="top">Category:</td>
                            <td valign="top"><input name="s_category" type="text" class="swifttext" id="s_category"
                                size="30" autocomplete="off" /></td>
                          </tr>
                          <tr bgcolor="#edf4ff">
                            <td valign="top">Caller Type:</td>
                            <td valign="top"><input name="s_callertype" type="text" class="swifttext" id="s_callertype"
                                size="30" autocomplete="off" /></td>
                          </tr>
                          <tr bgcolor="#f7faff">
                          ...
                          <tr bgcolor="#edf4ff">
                            ...
                            <td valign="top"><label>
                              ...
                              <label>
                                ...
                                No</label>
                              <label><input type="radio" name="flagdatabasefield" id="flagdatabasefield1" value=""
                                  checked="checked" />
                                Nor Both</label>
                            </td>
                          </tr>
