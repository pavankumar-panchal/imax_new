...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
        ...
        <td colspan="2" valign="top"><div id="maindiv">
          <form action="" method="post" name="submitform" id="submitform" onsubmit="return false;">
            <table width="100%" border="0" cellspacing="0" cellpadding="2">
              ...
              <tr>
                <td colspan="3" align="right" valign="middle" style="padding-right:15px; border-top:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="35">
  <tr>
                <td width="68%" height="35" align="left" valign="middle"><div id="form-error"></div></td>
                <td width="32%" height="35" align="right" valign="middle"><input name="display" type="button" class="swiftchoicebutton" id="display" value="Display" onclick="attendancedisplay()" />&nbsp;&nbsp;&nbsp;
                 <!-- <input name="advanced" type="button" class="swiftchoicebutton-orange" id="advanced" value="Advanced" href="./index.php?a_link=attendance_report_adv'" />--> <a href="./index.php?a_link=attendance_report_adv">Advanced</a></td>
              </tr>
</table></td>
              </tr>
            </table>
  ...
  <tr>
    <td><img src="../images/white-box.gif" align="absmiddle" style="border:1px solid #666666" /> &nbsp;Absent<br />
<br />
<img src="../images/orange-box.gif" align="absmiddle" style="border:1px solid #666666" /> &nbsp;Holiday<br />
<br />
<img src="../images/blue-box.gif" align="absmiddle" style="border:1px solid #666666" /> &nbsp;Present on Holiday<br />
<br />
<img src="../images/yellow-box.gif" align="absmiddle" style="border:1px solid #666666" /> &nbsp;Half Day<br />
<br />
<img src="../images/green-box.gif" align="absmiddle" style="border:1px solid #666666" /> &nbsp;Present</td>
  </tr>
</table>
</td>
    <td valign="top"><div id="tabgroupgridc1" style="height:auto; width:900PX; padding:2px;" align="center"></div></td>
  </tr>
</table>
</tr>
    </table></td>
