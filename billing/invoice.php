...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
              ...
              <tr>
                <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top">
                        <input name="customername" type="text" class="swifttext" id="customername" size="30" readonly="readonly" value=""  autocomplete = "off" style="background:#FEFFE6;"/>
                        <span id="getcustomerlink" style="visibility:visible;"> <a href="javascript:void(0);" onClick="getregisterdata(); getcustomerfunc();registernameload('invoice');" style="cursor:pointer"> 
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top">
                        <input name="customerid" type="text" class="swifttext" id="customerid" size="30" readonly="readonly" value=""  autocomplete = "off" style="background:#FEFFE6;"/>
                      </td>
                    </tr>
                     ...
                     <tr bgcolor="#f7faff">
                      ...
                      <td valign="top">
                      	<input name="productgroup" type="text" class="swifttext" id="productgroup" size="30"  readonly="readonly"  autocomplete="off" style="background:#FEFFE6;" />
                      </td>
                    </tr>
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top">
                      	<input name="productname" type="text" class="swifttext" id="productname" size="30" readonly="readonly"  autocomplete="off" style="background:#FEFFE6;" />
                      </td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Product Version:</td>
                      <td valign="top">
                        <input name="productversion" type="text" class="swifttext" id="productversion" size="30"  readonly="readonly"  autocomplete="off" style="background:#FEFFE6;" />
                      </td>
                    </tr>
                     <tr bgcolor="#edf4ff">
                      <td valign="top">State:</td>
                      <td valign="top">
                          <select name="state" id="state" class="swifttext" autocomplete="off" readonly="readonly" maxlength="10"   style="background:#FEFFE6;" >
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top">
                        <input name="billno" type="text" class="swifttext" id="billno" size="30" maxlength="10"  readonly="readonly"  autocomplete="off"  style="background:#FEFFE6;" />
                      </td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                      <td valign="top">Bill Date:</td>
                      <td valign="top" bgcolor="#edf4ff">
                        <input name="billdate" type="text" class="swifttext" id="billdate" size="30" maxlength="10"  readonly="readonly"  autocomplete="off"  onBlur="this.value = datestringupdate(this.value)"  style="background:#FEFFE6;" />
                     </td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Register Name:</td>
                      <td valign="top">
                        <input name="registername" type="text" class="swifttext" id="registername" size="30" maxlength="10"  readonly="readonly"  autocomplete="off" style="background:#FEFFE6;"  />
                      </td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                      <td valign="top">Complaint ID:</td>
                      <td valign="top">
                        <input name="complaintid" type="text" class="swifttext" id="complaintid" size="30" maxlength="10"  readonly="readonly"  autocomplete="off"   style="background:#FEFFE6;"/>
                      </td>
                    </tr>
                    <tr bgcolor="#f7faff">
                ...
                <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="billto" type="text" class="swifttext" id="billto" size="30"  autocomplete="off"  /></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="amount" type="text" class="swifttext" id="amount" size="30" maxlength="10" onKeyPress="javascript:invoicetotalamount();"  onChange="javascript:invoicetotalamount();" style="text-align:right"  autocomplete="off" /></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                      <td valign="top">Tax Amount:</td>
                      <td valign="top"><input name="tax" type="text" class="swifttext" id="tax" size="30"  onKeyPress="javascript:invoicetotalamount();"  onChange="javascript:invoicetotalamount();" style="text-align:right"  autocomplete="off" /></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Total Amount:</td>
                      <td valign="top"><input name="tamount" type="text" class="swifttext" id="tamount" size="30" style="text-align:right;background:#FEFFE6;"  autocomplete="off" readonly="readonly" /></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
  ...
  <tr>
                ...
                <td width="32%" height="35" align="right" valign="middle"><input name="new" type="reset" class="swiftchoicebutton" id="new" value="New" onclick="newentry();clearinnerhtml();gettime(); " />
&nbsp;&nbsp;&nbsp;
              ...
              <tr>
                <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="fromdate" type="text" class="swifttext" id="DPC_fromdate" size="30" autocomplete="off"  style="background:#FEFFE6;" /></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                      <td valign="top">To Date:</td>
                      <td valign="top"><input name="todate" type="text" class="swifttext" id="DPC_todate" size="30" autocomplete="off"   style="background:#FEFFE6;" />                        </td>
                    </tr>
                    <tr bgcolor="#f7faff">
                   ...
                   <tr bgcolor="#f7faff">
                    ...
                    <tr bgcolor="#edf4ff">
                      <td valign="top">Bill Number:</td>
                      <td valign="top"><input name="s_billno" type="text" class="swifttextarea" id="s_billno" value="" size="30" /></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Bill Date:</td>
                ...
                <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    <tr bgcolor="#f7faff">
                      <td valign="top">Register Name:</td>
                      <td valign="top"><input name="s_registername" type="text" class="swifttext" id="s_registername" size="30"  autocomplete="off"/></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                      <td valign="top">Billed By:</td>
                    ...
                    <tr bgcolor="#f7faff">
                      <td valign="top">Amount:</td>
                      <td valign="top"><input name="s_amount" type="text" class="swifttext" id="s_amount" value="" size="30"  autocomplete="off"/></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
  ...
  <tr>
    <td style="padding:0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr style="border-left:none;border-right:none;">
        <td width="46%" style="padding:0; border:none;"><table width="114%" border="0" cellspacing="0" cellpadding="0">
          <tr>
        ...
        </table></td><td width="54%"><span id="tabgroupgridwb1"></span><span id="tabgroupgridwb2"></span><span id="tabgroupgridwb3"></span><span id="tabgroupgridwb4"></span></td>
      </tr>
