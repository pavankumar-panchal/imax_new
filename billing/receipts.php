              ...
              <tr>
                <td width="50%" valign="top" style="border-right:1px solid #d1dceb;"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    ...
                    <tr bgcolor="#edf4ff">
                      ...
                      <td valign="top">
                        <input name="customerid" type="text" class="swifttext" id="customerid" size="30" readonly="readonly" value=""  autocomplete = "off" style="background:#FEFFE6;"/>                      </td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Bill Number:</td>
                      <td valign="top">
                        <input name="billno" type="text" class="swifttext" id="billno" size="30" maxlength="10"  readonly="readonly"  autocomplete="off"  style="background:#FEFFE6;" />                      </td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                      <td valign="top">Bill Date:</td>
                      <td valign="top" bgcolor="#edf4ff">
                        <input name="billdate" type="text" class="swifttext" id="billdate" size="30" maxlength="10"  readonly="readonly"  autocomplete="off"  onBlur="this.value = datestringupdate(this.value)"  style="background:#FEFFE6;" /></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="receiptno" type="text" class="swifttext" id="receiptno" size="30"  autocomplete = "off"/></td>
                    </tr>
                </table></td>
                <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    <tr bgcolor="#f7faff">
                      <td valign="top">Receipt Date:</td>
                      <td valign="top"><input name="receiptdate" type="text" class="swifttext" id="DPC_receiptdate" size="30" value=""  autocomplete = "off"  style="background:#FEFFE6;" /></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top"><input name="chequeno" type="text" class="swifttext" id="chequeno" size="30" style="text-align:left"  autocomplete = "off"/></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                      <td valign="top">Amount:</td>
                      <td valign="top"><input name="amount" type="text" class="swifttext" id="amount" size="30" style="text-align:right;"  autocomplete = "off"/></td>
                    </tr>
                    <tr bgcolor="#f7faff">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                    <tr bgcolor="#f7faff">
                      <td valign="top">Receipt Number:</td>
                      <td valign="top"><input name="s_receiptno" type="text" class="swifttext" id="s_receiptno" size="30"  autocomplete = "off"/></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                      <td valign="top">Receipt Date:</td>
                      <td valign="top"><input name="s_receiptdate" type="text" class="swifttext" id="DPC_s_receiptdate" size="30" value=""  autocomplete = "off" style="background:#FEFFE6;" /></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top">Cheque Number:</td>
                      <td valign="top"><input name="s_chequeno" type="text" class="swifttext" id="s_chequeno" size="30" style="text-align:left"  autocomplete = "off"/></td>
                    </tr>
                    <tr bgcolor="#edf4ff">
                      <td valign="top">Amount:</td>
